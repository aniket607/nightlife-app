    ...
    return (
        <header className="sticky top-0 z-50 bg-transparent text-gray-100">
            <div className="max-w-3xl mx-auto px-2 sm:px-6 lg:px-8 py-2 sm:py-4">
                <div className="bg-[linear-gradient(110deg,rgba(0,0,0,0.9)_0%,rgba(20,20,20,0.95)_50%,rgba(0,0,0,0.9)_100%)] rounded-full px-4 sm:px-6 py-2 border border-gray-800/40 relative">
